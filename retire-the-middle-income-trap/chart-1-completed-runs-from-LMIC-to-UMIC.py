...
facet_chart('leg1', 'Completed runs from LMIC to UMIC', 'Income relative to the moving UMIC entry line, economies ordered fastest to slowest', 'chart-1-completed-runs-from-LMIC-to-UMIC.png')
write_chart_csv('chart-1-completed-runs-from-LMIC-to-UMIC.csv', 'leg1', False)
