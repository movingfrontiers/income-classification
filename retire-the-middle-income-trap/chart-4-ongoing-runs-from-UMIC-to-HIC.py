...
facet_chart('leg2', 'Ongoing runs from UMIC to HIC', 'Income relative to the moving HIC line, economies ordered by distance to the median run', 'chart-4-ongoing-runs-from-UMIC-to-HIC.png', ongoing=True)
write_chart_csv('chart-4-ongoing-runs-from-UMIC-to-HIC.csv', 'leg2', True)
